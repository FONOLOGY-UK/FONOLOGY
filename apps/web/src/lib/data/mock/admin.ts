...
const seededJobs: Job[] = [
  {
    ...
    problem: 'Cracked screen, touch still works',
    notes: 'Wants original part.',
    quote: pounds(149),
    payment: 'paid-advance',
    status: 'new',
    source: 'walk-in',
  ...
  },
  {
    ...
    phone: '07700 900412',
    device: 'Galaxy S22',
    problem: 'Battery drains in 3 hours',
    quote: pounds(69),
    payment: 'unpaid',
    status: 'new',
    source: 'walk-in',
  ...
  },
  {
    ...
    device: 'iPhone 14',
    problem: 'Front screen replacement (mail-in)',
  ...
  },
  {
    ...
    device: 'Galaxy S23',
    problem: 'Battery replacement (mail-in)',
    quote: pounds(64),
    payment: 'unpaid',
    status: 'done',
    source: 'mail-in',
  ...
  },
  {
    ...
    problem: 'Keyboard — three dead keys',
    quote: pounds(145),
    payment: 'paid-advance',
    status: 'collected',
    source: 'online',
